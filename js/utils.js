...
// Generate a 6-char couple code (no confusing chars like O/0/I/1/L)
...
function getCoupleCode() {
  return localStorage.getItem('lovelore_couple_code') || null;
}

function setCoupleCode(code) {
  localStorage.setItem('lovelore_couple_code', code.toUpperCase());
}

function hasCoupleCode() {
  return localStorage.getItem('lovelore_couple_code') !== null;
}
